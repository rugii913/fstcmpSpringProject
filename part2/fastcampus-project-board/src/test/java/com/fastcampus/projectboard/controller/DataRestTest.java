...
@Transactional // integration test이므로 꼭 테스트 후 롤백되도록
@AutoConfigureMockMvc
@SpringBootTest // 설정하기 벅차다면 그냥 integration test로 작성하는 것이 가장 간편
// Spring Data REST를 사용하지 않는다면 mock repository를 넣어서 흐름을 끊을 수도 있지만,
// Spring Data REST를 사용하고 있기 때문에, 흐름을 끊으면 테스트가 동작하지 않음 
// - 억지로 테스트를 작성하고자 하면 integration test가 그나마 가장 나은 방법이 됨
//@WebMvcTest // @WebMvcTest는 내부적으로 MockMvc 사용 가능하도록 빈을 준비해줌
